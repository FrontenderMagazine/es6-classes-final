...
##### _constructor_, статические методы, прототипные методы
...
Иногда его называют _конструктор класса_. Он имеет особенности которые 
обычный конструктор функции не имеет (главным образом, способность 
конструтора вызыватьконструктор базового класса через _super()_, о котором 
...
*   Направляющие функции специализируются на callback's не-методов, где их
