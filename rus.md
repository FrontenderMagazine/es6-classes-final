...
*   `Reflect.construct()` [5](#anchor-5) позволяет вызвать конструктор при задании
...
с помощью конструкторов. [6](#anchor-6)
...
предпочел, чтобы они были прототипными (на основе конструктора объектов [6](#anchor-6), 
...
1. <span id="anchor-1">[Реформа создания экземпляров: в последний раз][13]</span>, слайды Аллена Вирфс-Брока (Allen Wirfs-Brock).
2. <span id="anchor-2">[Анализ ES6: Обновление до новой версии JavaScript][14]</span>, книга Акселя Роушмайера (Axel Rauschmayer)
3. <span id="anchor-3">[Символы в ECMAScript 6][15]</span>
4. <span id="anchor-4">[Итераторы и генераторы в ECMAScript 6][16]</span>
5. <span id="anchor-5">[Метапрограммирование с прокси в ECMAScript 6][17]</span>
6. <span id="anchor-6">[Прототипы и классы – введение в наследование на JavaScript][18]</span>
