...
является объектом. _prototype_ это специальное свойство, значение которого 
...
*   _this_ инициалированый в производных конструкторах значит что,
    ...
    вызвали _super()_.
*   После инициализации _this_, вызова _super()_ приведет к _ReferenceError_.
...
хранится _главный объект_ этот метод. Например, 
...
подход поддериживается [двумя внутренними *привязками*][10] которые имеет 
